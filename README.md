...
```
项目里引用lomboke需要eclipse安装该插件，IDE自带，项目引用lombok也是减少get/set 这类鸡肋代码，同时还可以方便地实现很多Builder模式等
```
# unit-test-demo 工程相关
...
方法2:命令行直接运行
+ 1. mvn org.jacoco:jacoco-maven-plugin:prepare-agent test org.jacoco:jacoco-maven-plugin:report  
...
### verify
[see demo](./src/test/java/com/example/ut/demo/service/JmsWorkerTest.java)
